...
Section EXTCALL_SM.
  ...
  Hypothesis SEP : globals_separate tge F1 F2.
  ...
  { apply match_stacks_nil with bound1; auto. 
    ...
    remember (Finj1 b1) as d; apply eq_sym in Heqd.
      destruct d.
        ...
        eapply (as_inj_DomRng _ _ _ _ H0 WDF2).
...
(*NEW*) Variable hf : I64Helpers.helper_functions.
  Lemma MATCH_initial_core: forall 
                               ...
                               (InitMem : exists m0 : mem, Genv.init_mem SrcProg = Some m0 
                                                           /\ Ple (Mem.nextblock m0) (Mem.nextblock m1)  (*Net needed/ Can remove just this one ineq*)
...
(forall pubSrc' pubTgt' : block -> bool,
  ...
  Proof. intros. 
         ...
         rewrite (INC _ _ _ Heqd) in H0. trivial. (*2 goals*)
...
(*
  Lemma step_simulation_noeffect: forall (st1 : RTL_core) (m1 : mem) (st1' : RTL_core) (m1' : mem)
    ...
    eapply match_stacks_inside_inlined; eauto.
    (* Need to get  locBlocksTgt from MS0*)
