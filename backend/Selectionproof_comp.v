...
Proof. intros.
  destruct MC as [[MS [RCLocs [PG [GFun [Glob [SMV [WD INJ]]]]]]] MRR].
...
{ (*skip seq*)
      ...
      apply gsep_refl. (*apply sm_inject_separated_same_sminj.*)
...
(*halted*) 
  { intros. destruct H as [[MC [RC [PG [GFP [GF [VAL [WD INJ]]]]]]] MRR]. 
    ...
    inv MC. exists v'. inv H1.  intuition. }
(* at_external*)
  ...
  { intros. destruct H0 as [MTCH [MRR1 MRR2]].
    ...
    split. 
      ...
      split. apply effstep_corestep in H.
             ...
             eapply cmin_coop_readonly. apply H.
