...
Proof. intros.
 destruct H as [[MC [RC [PG [GFP [Glob [SMV WDmu]]]]]] [MRR1 MRR]].
...
Proof. intros. simpl.
 destruct MTCH as [[MC [RC [PG [GFP [Glob [VAL WDmu]]]]]] MRR].
...
intros.
  ...
  exploit funct_ptr_translated; eauto. intros FP.
    subst. inv Heqzz. unfold tge in FP. inv FP. rewrite H3. 
  ...
  change (fn_sig (transf_function f)) with (funsig (Internal (transf_function f))).
...
Proof.
apply simulations_lemmas.inj_simulation_plus with
...
(*MATCHinitial*)
  { apply MATCH_initial. }
(*halted*) 
  { intros. destruct H as [[MC [RC [PG [GFP [Glob [SMV WD]]]]]] MRR]. 
