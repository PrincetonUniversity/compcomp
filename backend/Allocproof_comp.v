...
Lemma MATCH_atExternal: forall (mu : SM_Injection) (c1 : RTL_core) (m1 : mem) (c2 : LTL_core)
...
Proof.
 intros. destruct H as [[MC [RC [PG [GFP [Glob [SMV [WD INJ]]]]]]] [MRR1 MRR2]].
    split; trivial.
    split; trivial.
    split; trivial.
...
(*halted*) 
  { intros. destruct H as [[MC [RC [PG [GFP [GF [VAL [WD INJ]]]]]]] [MRR1 MRR2]]. 
