...
exists st2' m2', 
  (corestep_plus (LTL_eff_sem hf) tge st2 m2 st2' m2' \/
   ...
   corestep_star (LTL_eff_sem hf) tge st2 m2 st2' m2')
/\ exists mu',
  intern_incr mu mu' /\
...
{ (* entering a block *)
  ...
  (corestep_plus (LTL_eff_sem hf) tge
...
{ (* Lbuiltin *)
  ...
  intros [mu' [v' [m'' [TEC [ResInj [MINJ' 
         [UNMAPPED [LOOR [INC [SEP [LOCALLOC [WD' [SMV' RC']]]]]]]]]]]]]. 
...
{ (* unobservable external function *) 
  ...
  eexists; eexists; split.
    left. eapply corestep_plus_one.
      eapply ltl_exec_function_external; eauto.
           econstructor. eassumption. reflexivity.
  exists mu'.
  split; trivial. 
  split; trivial.
