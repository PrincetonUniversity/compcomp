...
Lemma CMin_decay g c m c' m'
            (CS: CMin_corestep g c m c' m'): decay m m'.
  Proof.
...
Program Definition cmin_decay_sem : 
  @DecayCoreSem Cminor.genv CMin_core.
Proof.
apply Build_DecayCoreSem with (decaysem := cmin_coop_sem).
  apply CMin_decay. 
Defined.
