...
Proof.
    ...
    intros. split.
     ...
     intros [f H].  unfold  transl_program in TRANSL.
         apply (@Genv.find_funct_ptr_rev_transf_partial2
           _ _ _ _ transl_fundef transl_globvar _ _ TRANSL) in H.
...
Proof. intros.
simpl.
 destruct MatchMu as [[MC [RC [PG [GF [Glob [VAL [WDmu INJ]]]]]]] MRR].
 ...
 assert (INCvisNu': inject_incr
  (restrict (as_inj nu')
     (vis
      ...
      apply restrict_incr. 
assert (RC': REACH_closed m1' (mapped (as_inj nu'))) by
...
Proof. intros. destruct H as [[MC [RC [PG [GFP [Glob [SMV [WD INJ]]]]]]] [MRR1 MRR2]].
    split; trivial.
    split; trivial.
    split; trivial.
...
(*halted*) 
  { intros. destruct H as [[MC [RC [PG [GF [Glob [VAL [WD INJ]]]]]]] [MRR1 MRR2]]. 
